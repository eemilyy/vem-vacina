...
class VacinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacina" do
    assert_difference('Vacina.count') do
      post vacinas_url, params: { vacina: { data: @vacina.data, horario: @vacina.horario, localizacao: @vacina.localizacao, nome_vacina: @vacina.nome_vacina } }
    end
  ...
  test "should update vacina" do
    patch vacina_url(@vacina), params: { vacina: { data: @vacina.data, horario: @vacina.horario, localizacao: @vacina.localizacao, nome_vacina: @vacina.nome_vacina } }
